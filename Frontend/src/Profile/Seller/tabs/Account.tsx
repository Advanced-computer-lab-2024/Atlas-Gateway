...
import { useRequestDeleteSellerProfile, useSellerProfile } from "@/api/data/useProfile";
		...
		<Flex className="grid grid-cols-2 gap-4">
			<Flex isColumn gap="3" className="border-r border-black">
				...
				<Flex isColumn gap="2">
					...
					<Flex gap="2" isColumn>
						<Label.Thin300>Company</Label.Thin300>
						<Label.Mid500>
							{data?.companyName ?? "No company added"}
						</Label.Mid500>
					</Flex>
					<Flex gap="2" isColumn>
						<Label.Thin300>Description</Label.Thin300>
						<Label.Mid500>
